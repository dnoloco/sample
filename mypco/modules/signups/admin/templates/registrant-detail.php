...
<div class="wrap">
    <?php if (isset($error)): ?>
        ...
        <p>
            <a href="<?php echo esc_url(admin_url('admin.php?page=mypco-registrations')); ?>" class="button">
    ...
    <div class="card" style="max-width: 800px; margin-bottom: 20px;">
        <h2><?php _e('Payment Information', 'mypco-online'); ?></h2>
        <table class="form-table">
            <tr>
                <th style="width: 200px;"><?php _e('Payment Status', 'mypco-online'); ?>:</th>
                <td>
                    <?php
                    $status_colors = [
                        'paid' => 'green',
            ...
            <tr>
                <th><?php _e('Stripe Payment ID', 'mypco-online'); ?>:</th>
    ...
    <div class="card" style="max-width: 800px; margin-bottom: 20px;">
        <h2><?php _e('Form Responses', 'mypco-online'); ?></h2>
        <table class="form-table">
