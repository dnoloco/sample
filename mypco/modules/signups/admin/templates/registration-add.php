...
<div class="wrap">
    ...
    <h1><?php _e('Add Manual Registration', 'mypco-online'); ?></h1>
    ...
    <?php if ($saved): ?>
        <div class="notice notice-success is-dismissible">
            <p><?php _e('Registration added successfully!', 'mypco-online'); ?></p>
        </div>
    <?php endif; ?>

    <!-- Event Info -->
    <div class="card" style="max-width: 800px; margin-bottom: 20px;">
        <h2><?php _e('Event', 'mypco-online'); ?></h2>
    ...
    <form method="POST" style="max-width: 800px;">
        ...
        <table class="form-table">
            <tr>
                <th scope="row">
                    <label for="first_name"><?php _e('First Name', 'mypco-online'); ?> *</label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="last_name"><?php _e('Last Name', 'mypco-online'); ?> *</label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="email"><?php _e('Email', 'mypco-online'); ?> *</label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="phone"><?php _e('Phone', 'mypco-online'); ?></label>
                </th>
                <td>
                    <input type="tel" name="phone" id="phone" class="regular-text">
                    <p class="description"><?php _e('Optional', 'mypco-online'); ?></p>
                </td>
            </tr>
        </table>
        ...
        <p class="submit">
            <input type="submit" name="add_registration" class="button button-primary button-large" 
                   value="<?php esc_attr_e('Add Registration', 'mypco-online'); ?>">
        </p>
    </form>

    <div class="notice notice-info" style="max-width: 800px;">
        <p><strong><?php _e('Note:', 'mypco-online'); ?></strong> <?php _e('This creates a manual registration. The registrant will not receive automated emails or payment links.', 'mypco-online'); ?></p>
    </div>
</div>
