...
<div class="wrap">
    ...
    <?php if (isset($error)): ?>
        <h1><?php _e('Error', 'mypco-online'); ?></h1>
    ...
    <div style="margin-bottom: 15px;">
        <a href="<?php echo esc_url(admin_url('admin.php?page=mypco-services')); ?>" class="button">
            ← <?php _e('Back to All Plans', 'mypco-online'); ?>
        </a>
    </div>
    ...
    <?php if ($series): ?>
        <p style="font-size: 1.1em; color: #666; margin-top: 5px;">
            <?php _e('Series:', 'mypco-online'); ?> <?php echo esc_html($series); ?>
        </p>
    <?php endif; ?>
    ...
    <div class="card" style="margin-bottom: 20px;">
        <h2><?php _e('Plan Information', 'mypco-online'); ?></h2>
        <table class="form-table">
            ...
            <tr>
                <th scope="row"><?php _e('Time', 'mypco-online'); ?></th>
                <td><?php echo esc_html($time_str); ?></td>
            </tr>
            <tr>
                <th scope="row"><?php _e('Actions', 'mypco-online'); ?></th>
                <td>
                    <a href="<?php echo esc_url($pco_edit_link); ?>" class="button" target="_blank" rel="noopener">
                        <?php _e('Edit Plan in Planning Center ↗', 'mypco-online'); ?>
                    </a>
                </td>
            </tr>
        </table>
    ...
    <h2><?php _e('Team Members', 'mypco-online'); ?></h2>
        ...
        <li class="unconfirmed">
            <a href="<?php echo esc_url(add_query_arg('filter_status', 'U', remove_query_arg('filter_team'))); ?>" 
               <?php echo $filter_status === 'U' ? 'class="current"' : ''; ?>>
                <?php _e('Unconfirmed', 'mypco-online'); ?> 
    ...
    <div class="tablenav top">
        <div class="alignleft actions">
            ...
            <select name="view_mode" id="view-mode" 
                ...
                <option value="team" <?php selected($view_mode, 'team'); ?>>
                    <?php _e('Group by Team', 'mypco-online'); ?>
                </option>
                <option value="alpha" <?php selected($view_mode, 'alpha'); ?>>
                    <?php _e('Alphabetical', 'mypco-online'); ?>
                </option>
            </select>
            ...
            <?php if ($view_mode === 'alpha'): ?>
                <select name="filter_team" id="filter-team" 
                    ...
                    <option value="all"><?php _e('All Teams', 'mypco-online'); ?></option>
        ...
        <div class="alignright actions">
            <a href="<?php echo esc_url(admin_url('admin.php?page=mypco-services&view=clearstream_compose&plan_id=' . $plan_id . '&from=plan')); ?>" 
               class="button button-primary">
                <?php _e('📱 Message Team', 'mypco-online'); ?>
            </a>
        </div>
    </div>

    <?php if (empty($team_members)): ?>
        <p><?php _e('No team members found for this plan.', 'mypco-online'); ?></p>
    <?php else: ?>
                ...
                <div class="card" style="margin-bottom: 20px;">
                    ...
                    <table class="wp-list-table widefat fixed striped">
                        ...
                        <tr>
                            ...
                            <th><?php _e('Position', 'mypco-online'); ?></th>
                            <th style="width: 120px;"><?php _e('Status', 'mypco-online'); ?></th>
                        </tr>
                        </thead>
                        <tbody>
                        <?php foreach ($members as $member): ?>
                            <tr>
                                ...
                                <td>
                                    <?php
                                    $status_labels = [
                                        'C' => '<span style="color: green;">✓ ' . __('Confirmed', 'mypco-online') . '</span>',
                                        'U' => '<span style="color: orange;">? ' . __('Unconfirmed', 'mypco-online') . '</span>',
                                        'D' => '<span style="color: red;">✗ ' . __('Declined', 'mypco-online') . '</span>'
                                    ];
        ...
        <?php else: ?>
            ...
            <table class="wp-list-table widefat fixed striped">
                ...
                <tr>
                    <th><?php _e('Name', 'mypco-online'); ?></th>
                    <th><?php _e('Team', 'mypco-online'); ?></th>
                    <th><?php _e('Position', 'mypco-online'); ?></th>
                    <th style="width: 120px;"><?php _e('Status', 'mypco-online'); ?></th>
                </tr>
                </thead>
            ...
            <?php if ($row_count === 0): ?>
                <p><?php _e('No team members match the selected filters.', 'mypco-online'); ?></p>
            <?php endif; ?>
