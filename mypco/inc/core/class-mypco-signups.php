<?php
// includes/class-mypco-signups.php
...
class MyPCO_Signups {
    ...
    public function __construct(mypco_api_model $model) {
        global $wpdb;
        $this->model = $model;
        $this->table_name = $wpdb->prefix . 'mypco_signups';
        $this->registrations_table = $wpdb->prefix . 'mypco_registrations';
    }
    ...
    public static function create_tables() {
        ...
        $signups_table = $wpdb->prefix . 'mypco_signups';
        $registrations_table = $wpdb->prefix . 'mypco_registrations';
    ...
    private static function maybe_add_partial_payment_columns() {
        global $wpdb;
        $table_name = $wpdb->prefix . 'mypco_signups';
     ...
     */
    public function get_mypco_events($count = 50) {
        $params = [
            'filter' => 'future',
            'per_page' => $count,
            'include' => 'event'
        ...
        $transient_key = 'mypco_events_for_signups_' . $count;
