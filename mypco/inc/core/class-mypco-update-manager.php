...
class MyPCO_Update_Manager {
     ...
     * Plugin slug.
     */
    private $plugin_slug = 'mypco-online';
     ...
     */
    private $cache_key = 'mypco_update_data';
    ...
    private function __construct() {
        $this->plugin_basename = 'mypco-online/mypco-online.php';

        // Set API URL from constant (defined in mypco-online.php)
        $this->api_url = defined('MYPCO_LICENSE_API_URL') ? MYPCO_LICENSE_API_URL : 'https://your-site.com/mypco-license/api.php';

        // Allow filtering the API URL
        $this->api_url = apply_filters('mypco_license_api_url', $this->api_url);
    }
    ...
    public function check_for_updates($transient) {
        ...
        if ($update_data && $update_data['update_available']) {
            ...
            if (isset($update_data['download_url']) && !empty($update_data['download_url'])) {
                ...
                $plugin_data['upgrade_notice'] = 'A valid license is required for automatic updates. Please activate your license in MyPCO Settings.';
            }
    ...
    public function plugin_info($result, $action, $args) {
        ...
        $update_data = $this->get_update_data(MYPCO_VERSION);
        ...
        $info->sections = [
            ...
            'installation' => 'Upload the plugin files to /wp-content/plugins/mypco-online/, activate through WordPress.',
    ...
    public function force_check() {
        ...
        return $this->get_update_data(MYPCO_VERSION);
    }
}
