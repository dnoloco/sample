...
class MyPCO_Signups_Admin {
    ...
    public function __construct($loader, $api_model) {
        ...
        if ($mypco_signups_handler) {
            $this->signups_handler = $mypco_signups_handler;
        }
    }
    ...
    public function add_admin_pages() {
        ...
        add_submenu_page(
            'mypco-settings',
            __('Event Signups', 'mypco-online'),
            __('Signups', 'mypco-online'),
            'edit_posts',
            'mypco-signups',
        ...
        add_submenu_page(
            'mypco-settings',
            __('Event Registrations', 'mypco-online'),
            __('Registrations', 'mypco-online'),
            'edit_posts',
            'mypco-registrations',
    ...
    public function enqueue_admin_assets($hook) {
        ...
        if (strpos($hook, 'mypco-signups') === false && strpos($hook, 'mypco-registrations') === false) {
            return;
        }

        wp_enqueue_style(
            'mypco-signups-admin',
            MYPCO_PLUGIN_URL . 'modules/signups/admin/assets/css/signups-admin.css',
            [],
            MYPCO_VERSION
        );
        ...
        wp_enqueue_script(
            'mypco-signups-admin',
            MYPCO_PLUGIN_URL . 'modules/signups/admin/assets/js/signups-admin.js',
            ['jquery'],
            MYPCO_VERSION,
            true
        );
