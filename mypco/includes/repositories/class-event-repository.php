 ...
 * MyPCO architecture. Display code never calls the API directly —
...
class MyPCO_Event_Repository implements MyPCO_Repository_Interface {
     ...
     * @var string
     */
    const CACHE_GROUP = 'mypco_events';

    /**
     * @param MyPCO_API_Model       $api_model   The PCO API model.
     * @param MyPCO_Date_Helper|null $date_helper Optional date helper instance.
     */
    public function __construct( MyPCO_API_Model $api_model, $date_helper = null ) {
