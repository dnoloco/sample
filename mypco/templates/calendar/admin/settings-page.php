...
<div class="wrap">
    ...
    <a href="<?php echo esc_url($add_new_url); ?>" class="page-title-action"><?php _e('Add New', 'mypco-online'); ?></a>
    ...
    <table class="wp-list-table widefat fixed striped table-view-list">
        ...
        <tr>
            ...
            <th scope="col" class="manage-column column-page"><?php _e('Page', 'mypco-online'); ?></th>
        </tr>
        </thead>
        <tbody id="the-list">
        <?php if (empty($calendar_shortcodes)): ?>
            <tr class="no-items">
                <td class="colspanchange" colspan="4">
                    <?php _e('No calendar shortcodes found.', 'mypco-online'); ?>
                    <a href="<?php echo esc_url($add_new_url); ?>"><?php _e('Add New', 'mypco-online'); ?></a>
                </td>
            </tr>
        <?php else: ?>
            ...
            ?>
                <tr>
                    ...
                    <td class="page column-page"><?php echo !empty($page_links) ? implode(', ', $page_links) : '<span class="mypco-no-description">&mdash;</span>'; ?></td>
                </tr>
            <?php endforeach; ?>
        <?php endif; ?>
        </tbody>
