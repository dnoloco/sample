...
<div id="pco-view-month" class="pco-view-section<?php echo esc_attr($month_active); ?>">
    ...
    <div class="pco-month-header">
        <button id="pco-month-prev" class="pco-month-nav" title="<?php esc_attr_e('Previous Month', 'mypco-online'); ?>">
            <span class="dashicons dashicons-arrow-left-alt2"></span>
            <?php _e('Previous', 'mypco-online'); ?>
        </button>
        ...
        <button id="pco-month-next" class="pco-month-nav" title="<?php esc_attr_e('Next Month', 'mypco-online'); ?>">
    ...
    <div class="pco-month-calendar">
        ...
        <div class="pco-month-days-header">
            <div class="pco-day-header"><?php _e('Sunday', 'mypco-online'); ?></div>
            <div class="pco-day-header"><?php _e('Monday', 'mypco-online'); ?></div>
            <div class="pco-day-header"><?php _e('Tuesday', 'mypco-online'); ?></div>
            <div class="pco-day-header"><?php _e('Wednesday', 'mypco-online'); ?></div>
            <div class="pco-day-header"><?php _e('Thursday', 'mypco-online'); ?></div>
            <div class="pco-day-header"><?php _e('Friday', 'mypco-online'); ?></div>
            <div class="pco-day-header"><?php _e('Saturday', 'mypco-online'); ?></div>
        </div>
        ...
        <div id="pco-month-grid" class="pco-month-grid">
            ...
            <div class="pco-month-loading">
                <p><?php _e('Loading calendar...', 'mypco-online'); ?></p>
            </div>
        </div>
    ...
    <div id="pco-month-events-list" class="pco-month-events-list">
        <h3 class="pco-month-events-title">
            <?php _e('Events This Month', 'mypco-online'); ?>
        </h3>
        ...
        <div id="pco-month-events-container" class="pco-month-events-container">
            ...
            <?php else: ?>
                <p class="pco-no-events">
                    <?php _e('No events found for this month.', 'mypco-online'); ?>
                </p>
            <?php endif; ?>
        </div>
    </div>
