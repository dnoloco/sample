# MyPCO License Server

A simple PHP-based license server for the MyPCO Online WordPress plugin.
...
2. Create a new database (e.g., `mypco_licenses`)
...
```
https://your-site.com/mypco-license/install.php?secret=YOUR_API_SECRET_KEY
```
...
- Verify the license key format: `MYPCO-XXXX-XXXX-XXXX-XXXX`
