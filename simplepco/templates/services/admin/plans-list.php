...
function simplepco_get_services_sort_url($column, $current_orderby, $current_order, $filter_type, $filter_month) {
    ...
    <ul class="subsubsub">
        ...
        <?php foreach ($service_types as $index => $type):
            ...
            <li class="type-<?php echo esc_attr($type_id); ?>">
                <a href="<?php echo esc_url(add_query_arg('filter_type', $type_id, admin_url('admin.php?page=simplepco-services'))); ?>"
