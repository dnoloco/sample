 ...
 * Used by [simplepco_payment_form registration_id="123"] shortcode.
 *
 * Available variables:
...
<?php if (isset($error)): ?>
    <div class="simplepco-payment-error">
...
<div class="simplepco-payment-form">
    ...
    <form id="simplepco-stripe-form" method="post">
...
(function() {
    ...
    const form = document.getElementById('simplepco-stripe-form');
    ...
    async function handlePayment(paymentMethodId) {
        ...
        formData.append('action', 'simplepco_process_payment');
...
.simplepco-button:hover {
    background: #005a87;
}

.simplepco-button:disabled {
    background: #ccc;
    cursor: not-allowed;
}
