...
<div class="wrap">
    ...
    <h1 class="wp-heading-inline"><?php _e('Registration Details', 'simplepco-online'); ?></h1>
    ...
    <div class="card" style="max-width: 800px; margin-bottom: 20px;">
        <h2><?php _e('Registration Information', 'simplepco-online'); ?></h2>
        <table class="form-table">
            <tr>
                <th style="width: 200px;"><?php _e('Registration ID', 'simplepco-online'); ?>:</th>
                <td><strong>#<?php echo intval($registration->id); ?></strong></td>
            </tr>
            <tr>
                <th><?php _e('Event', 'simplepco-online'); ?>:</th>
                <td><strong><?php echo esc_html($signup->event_name); ?></strong></td>
            </tr>
            <tr>
                <th><?php _e('Event Date', 'simplepco-online'); ?>:</th>
                <td><?php echo esc_html(mysql2date('l, F j, Y g:i A', $signup->event_date)); ?></td>
            </tr>
            <tr>
                <th><?php _e('Registration Date', 'simplepco-online'); ?>:</th>
                <td><?php echo esc_html(mysql2date('l, F j, Y g:i A', $registration->registration_date)); ?></td>
            </tr>
            <tr>
                <th><?php _e('Status', 'simplepco-online'); ?>:</th>
                <td>
                    <?php if ($registration->is_waitlist): ?>
                        <span style="color: orange; font-weight: bold;">
                            ⏳ <?php _e('Waitlist', 'simplepco-online'); ?>
                        </span>
                    <?php else: ?>
    ...
    <div class="card" style="max-width: 800px; margin-bottom: 20px;">
        <h2><?php _e('Payment Information', 'simplepco-online'); ?></h2>
        <table class="form-table">
            <tr>
                <th style="width: 200px;"><?php _e('Payment Status', 'simplepco-online'); ?>:</th>
                <td>
                    <?php
                    $status_colors = [
                        'paid' => 'green',
            ...
            <tr>
                <th><?php _e('Stripe Payment ID', 'simplepco-online'); ?>:</th>
    ...
    <div class="card" style="max-width: 800px; margin-bottom: 20px;">
        <h2><?php _e('Form Responses', 'simplepco-online'); ?></h2>
        <table class="form-table">
