...
<div class="wrap">
    ...
    <a href="<?php echo esc_url(admin_url('admin.php?page=simplepco-registrations&view=add&signup_id=' . $signup->id)); ?>" 
       class="page-title-action">
        <?php _e('Add Registration', 'simplepco'); ?>
    </a>
    <hr class="wp-header-end">

    <?php if ($deleted): ?>
        <div class="notice notice-success is-dismissible">
            <p><?php _e('Registration deleted successfully.', 'simplepco'); ?></p>
        </div>
    <?php endif; ?>

    <!-- Event Info Card -->
    <div class="card" style="margin-bottom: 20px;">
        <h2><?php _e('Event Information', 'simplepco'); ?></h2>
        <table class="form-table">
            ...
            <tr>
                <th scope="row"><?php _e('Capacity', 'simplepco'); ?></th>
                <td>
                    <?php if ($signup->max_attendees > 0): ?>
                        <?php echo count($confirmed); ?> / <?php echo intval($signup->max_attendees); ?> 
                        <?php _e('registrants', 'simplepco'); ?>
                    <?php else: ?>
                        <?php echo count($confirmed); ?> <?php _e('registrants (unlimited)', 'simplepco'); ?>
                    <?php endif; ?>
                </td>
            </tr>
            <?php if ($signup->payment_required): ?>
            <tr>
                <th scope="row"><?php _e('Payment', 'simplepco'); ?></th>
    ...
    <h2><?php _e('Confirmed Registrations', 'simplepco'); ?> (<?php echo count($confirmed); ?>)</h2>

    <?php if (empty($confirmed)): ?>
        <p><?php _e('No confirmed registrations yet.', 'simplepco'); ?></p>
    <?php else: ?>
        <table class="wp-list-table widefat fixed striped">
            ...
            <tr>
                ...
                <th style="width: 200px;"><?php _e('Email', 'simplepco'); ?></th>
                <th style="width: 120px;"><?php _e('Phone', 'simplepco'); ?></th>
                <th style="width: 100px;"><?php _e('Payment', 'simplepco'); ?></th>
                <th style="width: 150px;"><?php _e('Registered', 'simplepco'); ?></th>
                <th style="width: 120px;"><?php _e('Actions', 'simplepco'); ?></th>
            </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo esc_url(wp_nonce_url(admin_url('admin.php?page=simplepco-registrations&view=registrants&signup_id=' . $signup->id . '&action=delete&reg_id=' . $reg->id), 'delete_registration_' . $reg->id)); ?>" 
                           class="button button-small" 
                           onclick="return confirm('<?php esc_attr_e('Delete this registration?', 'simplepco'); ?>');">
    ...
    <?php if (!empty($waitlist)): ?>
        <h2 style="margin-top: 40px;"><?php _e('Waitlist', 'simplepco'); ?> (<?php echo count($waitlist); ?>)</h2>
        ...
        <table class="wp-list-table widefat fixed striped">
            ...
            <tr>
                ...
                <th style="width: 200px;"><?php _e('Email', 'simplepco'); ?></th>
                <th style="width: 120px;"><?php _e('Phone', 'simplepco'); ?></th>
                <th style="width: 150px;"><?php _e('Added', 'simplepco'); ?></th>
                <th style="width: 120px;"><?php _e('Actions', 'simplepco'); ?></th>
            </tr>
            </thead>
            <tbody>
