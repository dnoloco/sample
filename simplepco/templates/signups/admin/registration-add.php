...
<div class="wrap">
    ...
    <h1><?php _e('Add Manual Registration', 'simplepco'); ?></h1>
    ...
    <?php if ($saved): ?>
        <div class="notice notice-success is-dismissible">
            <p><?php _e('Registration added successfully!', 'simplepco'); ?></p>
        </div>
    <?php endif; ?>

    <!-- Event Info -->
    <div class="card" style="max-width: 800px; margin-bottom: 20px;">
        <h2><?php _e('Event', 'simplepco'); ?></h2>
    ...
    <form method="POST" style="max-width: 800px;">
        ...
        <table class="form-table">
            <tr>
                <th scope="row">
                    <label for="first_name"><?php _e('First Name', 'simplepco'); ?> *</label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="last_name"><?php _e('Last Name', 'simplepco'); ?> *</label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="email"><?php _e('Email', 'simplepco'); ?> *</label>
                </th>
                <td>
            ...
            <tr>
                <th scope="row">
                    <label for="phone"><?php _e('Phone', 'simplepco'); ?></label>
                </th>
                <td>
                    <input type="tel" name="phone" id="phone" class="regular-text">
                    <p class="description"><?php _e('Optional', 'simplepco'); ?></p>
                </td>
            </tr>
        </table>
        ...
        <p class="submit">
            <input type="submit" name="add_registration" class="button button-primary button-large" 
                   value="<?php esc_attr_e('Add Registration', 'simplepco'); ?>">
        </p>
    </form>

    <div class="notice notice-info" style="max-width: 800px;">
        <p><strong><?php _e('Note:', 'simplepco'); ?></strong> <?php _e('This creates a manual registration. The registrant will not receive automated emails or payment links.', 'simplepco'); ?></p>
    </div>
</div>
