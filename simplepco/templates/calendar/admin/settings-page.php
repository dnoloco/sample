...
<div class="wrap">
    ...
    <a href="<?php echo esc_url($add_new_url); ?>" class="page-title-action"><?php _e('Add New', 'simplepco-online'); ?></a>

    <?php if ($cache_cleared): ?>
        <div class="notice notice-success is-dismissible">
            <p><?php _e('Calendar cache cleared successfully!', 'simplepco-online'); ?></p>
        </div>
    <?php endif; ?>

    <p><?php _e('The Calendar module displays events from Planning Center Online Calendar with multiple views.', 'simplepco-online'); ?></p>
    ...
    <table class="wp-list-table widefat fixed striped table-view-list">
        ...
        <tr>
            ...
            <th scope="col" class="manage-column column-page"><?php _e('Page', 'simplepco-online'); ?></th>
        </tr>
        </thead>
        <tbody id="the-list">
        <?php if (empty($calendar_shortcodes)): ?>
            <tr class="no-items">
                <td class="colspanchange" colspan="4">
                    <?php _e('No calendar shortcodes found.', 'simplepco-online'); ?>
                    <a href="<?php echo esc_url($add_new_url); ?>"><?php _e('Add New', 'simplepco-online'); ?></a>
                </td>
            </tr>
        <?php else: ?>
    ...
    <div class="card">
        ...
        <p><?php _e('Clear the calendar cache to fetch fresh data from Planning Center Online.', 'simplepco-online'); ?></p>
        ...
        <form method="post" action="">
            ...
            <button type="submit" class="button button-secondary">
                <?php _e('Clear Calendar Cache', 'simplepco-online'); ?>
            </button>
        </form>
    </div>
</div>
