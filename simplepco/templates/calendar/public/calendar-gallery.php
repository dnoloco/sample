<?php
/**
 * Standalone Calendar Gallery View Template
 *
 * Renders only the gallery view without the view switcher.
 * Used by the [simplepco_calendar_gallery] shortcode.
 *
 * Available variables:
...
// Gallery view is always active in standalone mode
$gallery_active = ' active';
?>

<div class="pco-wrapper pco-wrapper-standalone" data-initial-view="gallery" data-standalone="gallery">
    ...
    <div class="pco-layout-grid pco-grid-full-width">
        ...
        <div class="pco-main-content">
            <?php include SIMPLEPCO_PLUGIN_DIR . 'templates/calendar/public/event-gallery.php'; ?>
