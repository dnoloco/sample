...
function simple_church_features_shortcode() {
	$simplepco_active = simple_church_is_simplepco_active();
	ob_start();
	...
	?>
		<div class="module-grid">
			...
			<div class="module-card reveal">
				...
				<div class="module-card__text">
					<?php
					if ( shortcode_exists( 'simplepco_groups' ) ) {
						echo do_shortcode( '[simplepco_groups count="1"]' );
					} else {
			...
			<div class="module-card reveal">
				...
				<div class="module-card__text">
					...
					if ( shortcode_exists( 'simplepco_messages' ) ) {
						echo do_shortcode( '[simplepco_messages count="1" view="list"]' );
					} else {
...
function simple_church_get_next_sunday_event() {
	if ( ! class_exists( 'SimplePCO_API_Model' ) || ! class_exists( 'SimplePCO_Settings_Repository' ) ) {
		return false;
	}
	...
	$api = new SimplePCO_API_Model( $credentials['client_id'], $credentials['secret_key'], $timezone );
