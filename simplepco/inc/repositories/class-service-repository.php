...
class SimplePCO_Service_Repository implements SimplePCO_Repository_Interface {
    ...
    const CACHE_GROUP = 'simplepco_services';
    ...
    public function clear_cache() {
        ...
        $wpdb->query(
            $wpdb->prepare(
                ...
                '%_transient_simplepco_service%'
            )
        );
        $wpdb->query(
            $wpdb->prepare(
                "DELETE FROM {$wpdb->options} WHERE option_name LIKE %s",
                '%_transient_simplepco_plan%'
            )
        );
    }
