...
class SimplePCO_Services_Module extends SimplePCO_Module_Base {
    ...
    private function load_admin_component() {
        ...
        $this->admin = new SimplePCO_Services_Admin($this->loader, $this->api_model);
        $this->admin->init();
    }
    ...
    private function get_module_path($relative_path) {
        return SIMPLEPCO_PLUGIN_DIR . 'inc/modules/services/' . $relative_path;
    }
}
