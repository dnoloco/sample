...
class SimplePCO_Calendar_Shortcodes_Module extends SimplePCO_Module_Base {
    ...
    public function init() {
        ...
        $this->loader->add_filter('simplepco_shortcode_types', $this, 'register_shortcode_types');
    ...
    private function load_public_component() {
        ...
        $this->public = new SimplePCO_Calendar_Shortcodes_Public($this->loader, $this->api_model);
        $this->public->init();
    }
    ...
    private function get_module_path($relative_path) {
        return SIMPLEPCO_PLUGIN_DIR . 'inc/modules/calendar-shortcodes/' . $relative_path;
    }
}
