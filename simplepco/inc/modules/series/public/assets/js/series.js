...
(function($) {
    ...
    $(document).ready(function() {
        ...
        // Matches video containers in both list view (.simplepco-message-video-player)
        // and single view (.simplepco-message-single-video)
        $(document).on('click', '.simplepco-message-video-thumb', function() {
