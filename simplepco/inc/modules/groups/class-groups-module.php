...
class SimplePCO_Groups_Module extends SimplePCO_Module_Base {
    ...
    private function load_admin_component() {
        ...
        $this->admin = new SimplePCO_Groups_Admin($this->loader, $this->api_model);
        $this->admin->init();
    }
    ...
    private function load_public_component() {
        ...
        $this->public = new SimplePCO_Groups_Public($this->loader, $this->api_model);
        $this->public->init();
    }
    ...
    private function get_module_path($relative_path) {
        return SIMPLEPCO_PLUGIN_DIR . 'inc/modules/groups/' . $relative_path;
    }
}
