...
class SimplePCO_Calendar_Module extends SimplePCO_Module_Base {
     ...
     *
     * This is called by the main SimplePCO class before init(), ensuring
    ...
    public function register_repositories() {
        ...
        //   $this->loader->register_repository('calendar_settings', new SimplePCO_Calendar_Settings_Repository());
    }
    ...
    public function get_block_registrar() {
        ...
        return new SimplePCO_Calendar_Block_Registrar( $event_repo );
    }
    ...
    private function load_admin_component() {
        ...
        $this->admin = new SimplePCO_Calendar_Admin($this->loader, $this->api_model);
        $this->admin->init();
    }
    ...
    private function load_public_component() {
        ...
        $this->public = new SimplePCO_Calendar_Public($this->loader, $this->api_model);
        $this->public->init();
    }
    ...
    private function get_module_path($relative_path) {
        return SIMPLEPCO_PLUGIN_DIR . 'inc/modules/calendar/' . $relative_path;
    }
}
