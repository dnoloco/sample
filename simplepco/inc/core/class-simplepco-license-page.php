...
class SimplePCO_License_Page {
    ...
    public function render_license_page() {
        ...
        ?>
        <div class="wrap">
            <h1><?php _e('SimplePCO License', 'simplepco-online'); ?></h1>

            <div class="simplepco-license-container" style="max-width: 800px;">

                <!-- Current Status Card -->
                <div class="card" style="max-width: 100%; margin-bottom: 20px;">
                    <h2><?php _e('License Status', 'simplepco-online'); ?></h2>
                        ...
                        <div class="simplepco-license-active" style="background: #ecf7ed; border-left: 4px solid #46b450; padding: 15px; margin: 15px 0;">
                            <p style="margin: 0;">
                                ...
                                <strong style="font-size: 16px; margin-left: 10px;">
                                    <?php printf(__('%s License Active', 'simplepco-online'), esc_html($license_status['tier_label'])); ?>
                                </strong>
                            </p>
                            <table class="form-table" style="margin-top: 15px;">
                                <tr>
                                    <th scope="row"><?php _e('License Key', 'simplepco-online'); ?></th>
                                    <td><code><?php echo esc_html($this->mask_license_key($license_key)); ?></code></td>
                                </tr>
                                <tr>
                                    <th scope="row"><?php _e('Tier', 'simplepco-online'); ?></th>
                                    <td><?php echo esc_html($license_status['tier_label']); ?></td>
                                </tr>
                                <?php if ($license_status['expires_at']): ?>
                                <tr>
                                    <th scope="row"><?php _e('Expires', 'simplepco-online'); ?></th>
                                    <td><?php echo esc_html(date('F j, Y', strtotime($license_status['expires_at']))); ?></td>
                                </tr>
                                <?php endif; ?>
                                <tr>
                                    <th scope="row"><?php _e('Available Modules', 'simplepco-online'); ?></th>
                                    <td>
                                        <?php
                                ...
                                <tr>
                                    <th scope="row"><?php _e('Site Activations', 'simplepco-online'); ?></th>
                                    <td><?php printf(__('%d remaining', 'simplepco-online'), $license_status['sites_remaining']); ?></td>
                                </tr>
                                <?php endif; ?>
                            </table>
                    ...
                    <?php else: ?>
                        <div class="simplepco-license-inactive" style="background: #fff8e5; border-left: 4px solid #dba617; padding: 15px; margin: 15px 0;">
                            <p style="margin: 0;">
                                ...
                                <strong style="font-size: 16px; margin-left: 10px;">
                                    <?php _e('No Active License', 'simplepco-online'); ?>
                                </strong>
                            </p>
                            <p style="color: #666; margin-top: 10px;">
                                <?php _e('Enter your license key below to activate premium modules and features.', 'simplepco-online'); ?>
                            </p>
                        </div>
                        ...
                        <form id="simplepco-license-form" style="margin-top: 20px;">
                            <table class="form-table">
                                <tr>
                                    <th scope="row">
                                        <label for="simplepco-license-key"><?php _e('License Key', 'simplepco-online'); ?></label>
                                    </th>
                                    <td>
                                        <input type="text"
                                        ...
                                        <p class="description">
                                            <?php _e('Enter your license key in the format: SIMPLEPCO-XXXX-XXXX-XXXX-XXXX', 'simplepco-online'); ?>
                                        </p>
                                    </td>
                                </tr>
                            </table>
                ...
                <div class="card" style="max-width: 100%;">
                    <h2><?php _e('Get a License', 'simplepco-online'); ?></h2>
                    <p><?php _e('Unlock premium modules and features with a SimplePCO license.', 'simplepco-online'); ?></p>
                    ...
                    <div class="simplepco-pricing-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 20px; margin-top: 20px;">
                        ...
                        <div class="simplepco-pricing-tier" style="border: 1px solid #ddd; border-radius: 4px; padding: 20px; text-align: center;">
                            <h3 style="margin-top: 0;"><?php _e('Starter', 'simplepco-online'); ?></h3>
                            ...
                            <ul style="text-align: left; padding-left: 20px; color: #666;">
                                <li><?php _e('Services Premium Features', 'simplepco-online'); ?></li>
                                <li><?php _e('Calendar Premium Features', 'simplepco-online'); ?></li>
                                <li><?php _e('1 Site Activation', 'simplepco-online'); ?></li>
                            </ul>
                        </div>
                        ...
                        <div class="simplepco-pricing-tier" style="border: 2px solid #2271b1; border-radius: 4px; padding: 20px; text-align: center; background: #f0f6fc;">
                            <span style="background: #2271b1; color: #fff; padding: 2px 8px; border-radius: 3px; font-size: 11px; font-weight: bold;"><?php _e('POPULAR', 'simplepco-online'); ?></span>
                            <h3 style="margin-top: 10px;"><?php _e('Professional', 'simplepco-online'); ?></h3>
                            <p style="font-size: 24px; font-weight: bold; margin: 10px 0;">$99<span style="font-size: 14px; font-weight: normal;">/year</span></p>
                            <ul style="text-align: left; padding-left: 20px; color: #666;">
                                <li><?php _e('All Premium Modules', 'simplepco-online'); ?></li>
                                <li><?php _e('Groups, Signups, Messages', 'simplepco-online'); ?></li>
                                <li><?php _e('3 Site Activations', 'simplepco-online'); ?></li>
                            </ul>
                        </div>

                        <div class="simplepco-pricing-tier" style="border: 1px solid #ddd; border-radius: 4px; padding: 20px; text-align: center;">
                            <h3 style="margin-top: 0;"><?php _e('Agency', 'simplepco-online'); ?></h3>
                            <p style="font-size: 24px; font-weight: bold; margin: 10px 0;">$249<span style="font-size: 14px; font-weight: normal;">/year</span></p>
                            <ul style="text-align: left; padding-left: 20px; color: #666;">
                                <li><?php _e('All Premium Modules', 'simplepco-online'); ?></li>
                                <li><?php _e('Priority Support', 'simplepco-online'); ?></li>
                                <li><?php _e('25 Site Activations', 'simplepco-online'); ?></li>
                            </ul>
                        </div>
                    ...
                    <p style="margin-top: 20px; text-align: center;">
                        <a href="https://your-site.com/pricing" target="_blank" class="button button-primary button-hero">
                            <?php _e('Purchase a License', 'simplepco-online'); ?>
                        </a>
                    </p>
                </div>
                <?php endif; ?>
        ...
        jQuery(document).ready(function($) {
            ...
            $('#simplepco-license-form').on('submit', function(e) {
                ...
                if (!licenseKey) {
                    $msg.html('<div class="notice notice-error"><p><?php _e('Please enter a license key.', 'simplepco-online'); ?></p></div>').show();
                    return;
                }

                $btn.prop('disabled', true).text('<?php _e('Activating...', 'simplepco-online'); ?>');
                $msg.hide();
                ...
                $.post(ajaxurl, {
                    ...
                    if (res.success) {
                        ...
                        $msg.html('<div class="notice notice-error"><p>' + (res.data.message || '<?php _e('Activation failed.', 'simplepco-online'); ?>') + '</p></div>').show();
                        $btn.prop('disabled', false).text('<?php _e('Activate License', 'simplepco-online'); ?>');
                    }
                }).fail(function() {
                    $msg.html('<div class="notice notice-error"><p><?php _e('Connection error. Please try again.', 'simplepco-online'); ?></p></div>').show();
                    $btn.prop('disabled', false).text('<?php _e('Activate License', 'simplepco-online'); ?>');
                });
            });
            ...
            $('#simplepco-deactivate-license').on('click', function() {
                if (!confirm('<?php _e('Are you sure you want to deactivate your license from this site?', 'simplepco-online'); ?>')) {
                    return;
                }

                var $btn = $(this);
                $btn.prop('disabled', true).text('<?php _e('Deactivating...', 'simplepco-online'); ?>');
                ...
                $.post(ajaxurl, {
                    ...
                    alert('<?php _e('Error deactivating license.', 'simplepco-online'); ?>');
                    $btn.prop('disabled', false).text('<?php _e('Deactivate License', 'simplepco-online'); ?>');
                });
            });
            ...
            $('#simplepco-refresh-license').on('click', function() {
                ...
                $.post(ajaxurl, {
                    ...
                    alert('<?php _e('Error refreshing license status.', 'simplepco-online'); ?>');
    ...
    public function ajax_activate_license() {
        ...
        if (empty($license_key)) {
            wp_send_json_error(['message' => __('Please enter a license key.', 'simplepco-online')]);
        }
