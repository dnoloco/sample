...
class SimplePCO_Loader {

    use SimplePCO_Has_Repositories;
     ...
     *
     * @var SimplePCO_Block_Registrar_Interface[]
     */
     ...
     *
     * @param SimplePCO_Block_Registrar_Interface $registrar A module's block registrar.
     * @return void
     */
    public function add_block_registrar( SimplePCO_Block_Registrar_Interface $registrar ) {
